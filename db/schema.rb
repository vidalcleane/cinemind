...
ActiveRecord::Schema[7.1].define(version: 2025_10_26_133821) do
  ...
  create_table "movie_imports", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["status"], name: "index_movie_imports_on_status"
    t.index ["user_id"], name: "index_movie_imports_on_user_id"
  end
  ...
  add_foreign_key "movie_imports", "users"
